...
pub fn density_g_per_ml(name: &str) -> Option<f64> {
    ...
    let table: &[(&str, f64)] = &[
        ...
        ("clove powder", 0.45),
        ("curry powder", 0.45),
        ("madras curry powder", 0.45),
        ("ground cardamom", 0.45),
        ("cardamom powder", 0.45),
        ("ground green cardamom", 0.45),
        ("ground green cardamom seeds", 0.45),
        ("ground black cardamom seeds", 0.45),
        ("ground fenugreek", 0.50),
        ("ground fennel", 0.45),
        ("ground mace", 0.35),
        ("mace powder", 0.35),
        ("mango powder", 0.45),
        ("amchur", 0.45),
        ("amchoor", 0.45),
        ("saffron threads", 0.15),
        ("saffron", 0.15),
        ("dried basil", 0.15),
        ("dried oregano", 0.15),
        ("dried thyme", 0.15),
        ("dried mint", 0.15),
        ("dried mint leaves", 0.15),
        ...
        ("fresh ginger", 0.55),
        ("ginger", 0.55),
        ("minced fresh mint leaves", 0.20),
        ("chopped fresh mint", 0.20),
        ("fresh mint leaves", 0.20),
        ("mint leaves", 0.20),
        ("chopped mint", 0.20),
        // --- chopped produce (volume of loosely-packed pieces) ---
        ("finely chopped onion", 0.68),
        ("chopped onion", 0.68),
        ("chopped onions", 0.68),
        ("chopped tomatoes", 0.85),
        // --- dals / legumes / nuts / dried fruit (volume of dry goods) ---
        ("dried yellow split chickpeas", 0.85),
        ("chana dal", 0.85),
        ("split chickpeas", 0.85),
        ("dried white urad beans", 0.85),
        ("urad dal", 0.85),
        ("moong dal", 0.85),
        ("masoor dal", 0.85),
        ("toor dal", 0.85),
        ...
        ("raisins", 0.60),
        ("sultanas", 0.60),
        // --- vinegars / juices / condiments (near-water liquids) ---
        ("distilled white vinegar", 1.01),
        ("white vinegar", 1.01),
        ("rice vinegar", 1.01),
        ("balsamic vinegar", 1.01),
